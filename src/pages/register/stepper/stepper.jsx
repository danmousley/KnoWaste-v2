    ...
    return (
        <nav class="container stepper h-100">
            <div class="row stepper__row h-100">
                <div data-testid="stepper-step1" className={`col step ${stepStyles(1)}`} >
                ...
                <div data-testid="stepper-step2" className={`col step ${stepStyles(2)}`} >
                ...
                <div data-testid="stepper-step3" className={`col step ${stepStyles(3)}`} >
